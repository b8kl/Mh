...
function Library:CreateWindow(titleText)
    ...
    local MainFrame = Create("Frame", {
        ...
        Visible = true, 
        ClipsDescendants = false, -- Improved performance for large scripts
        Parent = screenGui
    ...
    local Window = {}
    local firstTab = true
    local allPages = {} -- Store all pages to prevent visibility issues
    ...
    function Window:CreateTab(name)
        ...
        function Tab:Slider(data)
            -- Basic placeholder for Slider
            return self:CreateButton(data.Title .. " [Slider]", nil)
        end
        ...
        function Tab:Input(data)
            -- Basic placeholder for Input
            return self:CreateButton(data.Title .. " [Input]", nil)
        end
