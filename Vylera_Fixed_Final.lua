--[[ 
    ═══════════════════════════════════════════════════════════════
    VYLERA HUB - BLOX FRUITS (FIXED CONVERT V13)
    ═══════════════════════════════════════════════════════════════
]]
...
local LocalPlayerTab = Window:CreateTab('Player')
local StatsTab = Window:CreateTab('Stats')
local SeaEventTab = Window:CreateTab('Sea Event')
local SeaStackTab = Window:CreateTab('Sea Stack')
local SeaSettingsTab = Window:CreateTab('Sea Settings')
local DragonDojoTab = Window:CreateTab('Dragon Dojo')
...
-- UI ELEMENTS --
AutoLevelFarmToggle = MainTab:CreateToggle('Auto Farm Level', _G.Settings.Main["Auto Farm"], function(state)
        _G.Settings.Main["Auto Farm"] = state;
        StopTween(_G.Settings.Main["Auto Farm"]);
        (getgenv()).SaveSetting();
    end)
AutoFastFarmToggle = MainTab:CreateToggle('Auto Fast Farm', _G.Settings.Main["Auto Fast Farm"], function(state)
        _G.Settings.Main["Auto Fast Farm"] = state;
        StopTween(_G.Settings.Main["Auto Fast Farm"]);
        (getgenv()).SaveSetting();
    end)
AutoFruitMasteryToggle = MainTab:CreateToggle('Auto Fruit Mastery', _G.Settings.Main["Auto Farm Fruit Mastery"], function(state)
        _G.Settings.Main["Auto Farm Fruit Mastery"] = state;
        StopTween(_G.Settings.Main["Auto Farm Fruit Mastery"]);
        (getgenv()).SaveSetting();
    end)
AutoGunMasteryToggle = MainTab:CreateToggle('Auto Gun Mastery', _G.Settings.Main["Auto Farm Gun Mastery"], function(state)
        _G.Settings.Main["Auto Farm Gun Mastery"] = state;
        StopTween(_G.Settings.Main["Auto Farm Gun Mastery"]);
        (getgenv()).SaveSetting();
    end)
AutoSwordMasteryToggle = MainTab:CreateToggle('Auto Sword Mastery', _G.Settings.Main["Auto Farm Sword Mastery"], function(state)
        _G.Settings.Main["Auto Farm Sword Mastery"] = state;
        StopTween(_G.Settings.Main["Auto Farm Sword Mastery"]);
        (getgenv()).SaveSetting();
    end)
AutoSummonTyrantOfTheSkiesToggle = MainTab:CreateToggle('Auto Summon Tyrant Of The Skies', _G.Settings.Main["Selected Mon"], function(option)
        _G.Settings.Main["Selected Mon"] = option;
        (getgenv()).SaveSetting();
    end)
AutoMonFarmToggle = MainTab:CreateToggle('Auto Farm Mon', _G.Settings.Main["Auto Farm Mon"], function(state)
        _G.Settings.Main["Auto Farm Mon"] = state;
        StopTween(_G.Settings.Main["Auto Farm Mon"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmBossToggle = MainTab:CreateToggle('Auto Farm Boss', _G.Settings.Main["Auto Farm Boss"], function(state)
        _G.Settings.Main["Auto Farm Boss"] = state;
        StopTween(_G.Settings.Main["Auto Farm Boss"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmAllBossToggle = MainTab:CreateToggle('Auto Farm All Boss', _G.Settings.Main["Auto Farm All Boss"], function(state)
        _G.Settings.Main["Auto Farm All Boss"] = state;
        StopTween(_G.Settings.Main["Auto Farm All Boss"]);
        (getgenv()).SaveSetting();
    end)
AutoEliteHunterToggle = OthersTab:CreateToggle('Auto Elite Hunter', _G.Settings.Farm["Auto Elite Hunter"], function(state)
        _G.Settings.Farm["Auto Elite Hunter"] = state;
        StopTween(_G.Settings.Farm["Auto Elite Hunter"]);
        (getgenv()).SaveSetting();
    end)
AutoEliteHunterHopToggle = OthersTab:CreateToggle('Auto Elite Hunter Hop', _G.Settings.Farm["Auto Elite Hunter Hop"], function(state)
        _G.Settings.Farm["Auto Elite Hunter Hop"] = state;
        StopTween(_G.Settings.Farm["Auto Elite Hunter Hop"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmBoneToggle = OthersTab:CreateToggle('Auto Farm Bone', _G.Settings.Farm["Auto Farm Bone"], function(state)
        _G.Settings.Farm["Auto Farm Bone"] = state;
        StopTween(_G.Settings.Farm["Auto Farm Bone"]);
        (getgenv()).SaveSetting();
    end)
AutoRandomSurpriseToggle = OthersTab:CreateToggle('Auto Random Surprise', _G.Settings.Farm["Auto Random Surprise"], function(state)
        _G.Settings.Farm["Auto Random Surprise"] = state;
        StopTween(_G.Settings.Farm["Auto Random Surprise"]);
        (getgenv()).SaveSetting();
    end)
AutoPirateRaidToggle = OthersTab:CreateToggle('Auto Pirate Raid', _G.Settings.Farm["Auto Pirate Raid"], function(state)
        _G.Settings.Farm["Auto Pirate Raid"] = state;
        StopTween(_G.Settings.Farm["Auto Pirate Raid"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmChestTweenToggle = OthersTab:CreateToggle('Auto Farm Chest Tween', _G.Settings.Farm["Auto Farm Chest Tween"], function(state)
        _G.Settings.Farm["Auto Farm Chest Tween"] = state;
        StopTween(_G.Settings.Farm["Auto Farm Chest Tween"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmChestInstantToggle = OthersTab:CreateToggle('Auto Farm Chest Instant', _G.Settings.Farm["Auto Farm Chest Instant"], function(state)
        _G.Settings.Farm["Auto Farm Chest Instant"] = state;
        StopTween(_G.Settings.Farm["Auto Farm Chest Instant"]);
        (getgenv()).SaveSetting();
    end)
AutoStopItemsToggle = OthersTab:CreateToggle('Auto Stop Items', _G.Settings.Farm["Auto Stop Items"], function(state)
        _G.Settings.Farm["Auto Stop Items"] = state;
        StopTween(_G.Settings.Farm["Auto Stop Items"]);
        (getgenv()).SaveSetting();
    end)
AutoKatakuriToggle = OthersTab:CreateToggle('Auto Katakuri', _G.Settings.Farm["Auto Farm Katakuri"], function(state)
        _G.Settings.Farm["Auto Farm Katakuri"] = state;
        StopTween(_G.Settings.Farm["Auto Farm Katakuri"]);
        (getgenv()).SaveSetting();
    end)
AutoSpawnCakePrinceToggle = OthersTab:CreateToggle('Auto Spawn Cake Prince', _G.Settings.Farm["Auto Spawn Cake Prince"], function(state)
        _G.Settings.Farm["Auto Spawn Cake Prince"] = state;
        StopTween(_G.Settings.Farm["Auto Spawn Cake Prince"]);
        (getgenv()).SaveSetting();
    end)
AutoKillCakePrinceToggle = OthersTab:CreateToggle('Auto Kill Cake Prince', _G.Settings.Farm["Auto Kill Cake Prince"], function(state)
        _G.Settings.Farm["Auto Kill Cake Prince"] = state;
        StopTween(_G.Settings.Farm["Auto Kill Cake Prince"]);
        (getgenv()).SaveSetting();
    end)
AutoKillDoughKingToggle = OthersTab:CreateToggle('Auto Kill Dough King', _G.Settings.Farm["Auto Kill Dough King"], function(state)
        _G.Settings.Farm["Auto Kill Dough King"] = state;
        StopTween(_G.Settings.Farm["Auto Kill Dough King"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmMaterialToggle = OthersTab:CreateToggle('Auto Farm Material', _G.Settings.Farm["Auto Farm Material"], function(state)
        _G.Settings.Farm["Auto Farm Material"] = state;
        StopTween(_G.Settings.Farm["Auto Farm Material"]);
        (getgenv()).SaveSetting();
    end)
SpinPositionToggle = SettingsTab:CreateToggle('Spin Position', _G.Settings.Setting["Spin Position"], function(state)
        _G.Settings.Setting["Spin Position"] = state;
        (getgenv()).SaveSetting();
    end)
BringMobToggle = SettingsTab:CreateToggle('Bring Mob', true, function(state)
        _G.Settings.Setting["Bring Mob"] = state;
        (getgenv()).SaveSetting();
    end)
AttackAuraToggle = SettingsTab:CreateToggle('Atatck Aura', _G.Settings.Items["Attack Aura"], function(state)
        _G.Settings.Items["Attack Aura"] = state;
        (getgenv()).SaveSetting();
    end)
HideNotificationToggle = SettingsTab:CreateToggle('Hide Notification', _G.Settings.Setting["Hide Notification"], function(state)
        _G.Settings.Setting["Hide Notification"] = state;
        StopTween(_G.Settings.Setting["Hide Notification"]);
        (getgenv()).SaveSetting();
    end)
HideDamageTextToggle = SettingsTab:CreateToggle('Hide Damage Text', _G.Settings.Setting["Hide Damage Text"], function(state)
        _G.Settings.Setting["Hide Damage Text"] = state;
        StopTween(_G.Settings.Setting["Hide Damage Text"]);
        (getgenv()).SaveSetting();
    end)
BlackScreenToggle = SettingsTab:CreateToggle('Black Screen', _G.Settings.Setting["Black Screen"], function(state)
        _G.Settings.Setting["Black Screen"] = state;
        StopTween(_G.Settings.Setting["Black Screen"]);
        (getgenv()).SaveSetting();
    end)
WhiteScreenToggle = SettingsTab:CreateToggle('White Screen', _G.Settings.Setting["White Screen"], function(state)
        _G.Settings.Setting["White Screen"] = state;
        StopTween(_G.Settings.Setting["White Screen"]);
        (getgenv()).SaveSetting();
    end)
MasteryFruitSkillZToggle = SettingsTab:CreateToggle('Skill Z', true, function(state)
        _G.Settings.Setting["Fruit Mastery Skill Z"] = state;
        (getgenv()).SaveSetting();
    end)
MasteryFruitSkillXToggle = SettingsTab:CreateToggle('Skill X', true, function(state)
        _G.Settings.Setting["Fruit Mastery Skill X"] = state;
        (getgenv()).SaveSetting();
    end)
MasteryFruitSkillCToggle = SettingsTab:CreateToggle('Skill C', true, function(state)
        _G.Settings.Setting["Fruit Mastery Skill C"] = state;
        (getgenv()).SaveSetting();
    end)
MasteryFruitSkillVToggle = SettingsTab:CreateToggle('Skill V', _G.Settings.Setting["Fruit Mastery Skill V"], function(state)
        _G.Settings.Setting["Fruit Mastery Skill V"] = state;
        (getgenv()).SaveSetting();
    end)
MasteryFruitSkillFToggle = SettingsTab:CreateToggle('Skill F', _G.Settings.Setting["Fruit Mastery Skill F"], function(state)
        _G.Settings.Setting["Fruit Mastery Skill F"] = state;
        (getgenv()).SaveSetting();
    end)
MasteryGunSkillZToggle = SettingsTab:CreateToggle('Skill Z', true, function(state)
        _G.Settings.Setting["Gun Mastery Skill Z"] = state;
        (getgenv()).SaveSetting();
    end)
MasteryGunSkillXToggle = SettingsTab:CreateToggle('Skill X', true, function(state)
        _G.Settings.Setting["Gun Mastery Skill X"] = state;
        (getgenv()).SaveSetting();
    end)
AutoSetSpawnPointToggle = SettingsTab:CreateToggle('Auto Set Spawn Point', _G.Settings.Setting["Auto Set Spawn Point"], function(state)
        _G.Settings.Setting["Auto Set Spawn Point"] = state;
        (getgenv()).SaveSetting();
    end)
AutoObservationToggle = SettingsTab:CreateToggle('Auto Observation', _G.Settings.Setting["Auto Observation"], function(state)
        _G.Settings.Setting["Auto Observation"] = state;
        (getgenv()).SaveSetting();
    end)
AutoHakiToggle = SettingsTab:CreateToggle('Auto Haki', _G.Settings.Setting["Auto Haki"], function(state)
        _G.Settings.Setting["Auto Haki"] = state;
        (getgenv()).SaveSetting();
    end)
AutoRejoinToggle = SettingsTab:CreateToggle('Auto Rejoin', _G.Settings.Setting["Auto Rejoin"], function(state)
        _G.Settings.Setting["Auto Rejoin"] = state;
        (getgenv()).SaveSetting();
    end)
AutoSecondSeaToggle = ItemsTab:CreateToggle('Auto Second Sea', _G.Settings.Items["Auto Second Sea"], function(state)
        _G.Settings.Items["Auto Second Sea"] = state;
        StopTween(_G.Settings.Items["Auto Second Sea"]);
        (getgenv()).SaveSetting();
    end)
AutoThirdSeaToggle = ItemsTab:CreateToggle('Auto Third Sea', _G.Settings.Items["Auto Third Sea"], function(state)
        _G.Settings.Items["Auto Third Sea"] = state;
        StopTween(_G.Settings.Items["Auto Third Sea"]);
        (getgenv()).SaveSetting();
    end)
AutoSuperHumanToggle = ItemsTab:CreateToggle('Auto Super Human', _G.Settings.Items["Auto Super Human"], function(state)
        _G.Settings.Items["Auto Super Human"] = state;
        StopTween(_G.Settings.Items["Auto Super Human"]);
        (getgenv()).SaveSetting();
    end)
AutoDeathStepToggle = ItemsTab:CreateToggle('Auto Death Step', _G.Settings.Items["Auto Death Step"], function(state)
        _G.Settings.Items["Auto Death Step"] = state;
        StopTween(_G.Settings.Items["Auto Death Step"]);
        (getgenv()).SaveSetting();
    end)
AutoSharkmanKarateToggle = ItemsTab:CreateToggle('Auto Sharkman Karate', _G.Settings.Items["Auto Fishman Karate"], function(state)
        _G.Settings.Items["Auto Fishman Karate"] = state;
        StopTween(_G.Settings.Items["Auto Fishman Karate"]);
        (getgenv()).SaveSetting();
    end)
AutoElectricClawToggle = ItemsTab:CreateToggle('Auto Electric Claw', _G.Settings.Items["Auto Electric Claw"], function(state)
        _G.Settings.Items["Auto Electric Claw"] = state;
        StopTween(_G.Settings.Items["Auto Electric Claw"]);
        (getgenv()).SaveSetting();
    end)
AutoDragonTalonToggle = ItemsTab:CreateToggle('Auto Dragon Talon', _G.Settings.Items["Auto Dragon Talon"], function(state)
        _G.Settings.Items["Auto Dragon Talon"] = state;
        StopTween(_G.Settings.Items["Auto Dragon Talon"]);
        (getgenv()).SaveSetting();
    end)
AutoGodHumanToggle = ItemsTab:CreateToggle('Auto God Human', _G.Settings.Items["Auto God Human"], function(state)
        _G.Settings.Items["Auto God Human"] = state;
        StopTween(_G.Settings.Items["Auto God Human"]);
        (getgenv()).SaveSetting();
    end)
AutoGetSaberToggle = ItemsTab:CreateToggle('Auto Get Saber', _G.Settings.Items["Auto Saber"], function(state)
        _G.Settings.Items["Auto Saber"] = state;
        StopTween(_G.Settings.Items["Auto Saber"]);
        (getgenv()).SaveSetting();
    end)
AutoBuddySwordToggle = ItemsTab:CreateToggle('Auto Buddy Sword', _G.Settings.Items["Auto Buddy Sword"], function(state)
        _G.Settings.Items["Auto Buddy Sword"] = state;
        StopTween(_G.Settings.Items["Auto Buddy Sword"]);
        (getgenv()).SaveSetting();
    end)
AutoSoulGuitarToggle = ItemsTab:CreateToggle('Auto Soul Guitar', _G.Settings.Items["Auto Soul Guitar"], function(state)
        _G.Settings.Items["Auto Soul Guitar"] = state;
        StopTween(_G.Settings.Items["Auto Soul Guitar"]);
        (getgenv()).SaveSetting();
    end)
AutoRengokuToggle = ItemsTab:CreateToggle('Auto Rengoku', _G.Settings.Items["Auto Rengoku"], function(state)
        _G.Settings.Items["Auto Rengoku"] = state;
        StopTween(_G.Settings.Items["Auto Rengoku"]);
        (getgenv()).SaveSetting();
    end)
AutoHallowScytheToggle = ItemsTab:CreateToggle('Auto Hallow Scythe', _G.Settings.Items["Auto Hallow Scythe"], function(state)
        _G.Settings.Items["Auto Hallow Scythe"] = state;
        StopTween(_G.Settings.Items["Auto Hallow Scythe"]);
        (getgenv()).SaveSetting();
    end)
AutoWardenSwordToggle = ItemsTab:CreateToggle('Auto Warden Sword', _G.Settings.Items["Auto Warden Sword"], function(state)
        _G.Settings.Items["Auto Warden Sword"] = state;
        StopTween(_G.Settings.Items["Auto Warden Sword"]);
        (getgenv()).SaveSetting();
    end)
AutoGetYamaToggle = ItemsTab:CreateToggle('Auto Get Yama', _G.Settings.Items["Auto Yama"], function(state)
        _G.Settings.Items["Auto Yama"] = state;
        StopTween(_G.Settings.Items["Auto Yama"]);
        (getgenv()).SaveSetting();
    end)
AutoGetYamaHopToggle = ItemsTab:CreateToggle('Auto Get Yama Hop', _G.Settings.Items["Auto Yama Hop"], function(state)
        _G.Settings.Items["Auto Yama Hop"] = state;
        StopTween(_G.Settings.Items["Auto Yama Hop"]);
        (getgenv()).SaveSetting();
    end)
AutoGetTushitaToggle = ItemsTab:CreateToggle('Auto Get Tushita', _G.Settings.Items["Auto Tushita"], function(state)
        _G.Settings.Items["Auto Tushita"] = state;
        StopTween(_G.Settings.Items["Auto Tushita"]);
        (getgenv()).SaveSetting();
    end)
AutoDragonTridentToggle = ItemsTab:CreateToggle('Auto Dragon Trident', _G.Settings.Items["Auto Dragon Trident"], function(state)
        _G.Settings.Items["Auto Dragon Trident"] = state;
        StopTween(_G.Settings.Items["Auto Dragon Trident"]);
        (getgenv()).SaveSetting();
    end)
AutoDragonTridentToggle = ItemsTab:CreateToggle('Auto Greybeard', _G.Settings.Items["Auto Greybeard"], function(state)
        _G.Settings.Items["Auto Greybeard"] = state;
        StopTween(_G.Settings.Items["Auto Greybeard"]);
        (getgenv()).SaveSetting();
    end)
AutoSharkSawToggle = ItemsTab:CreateToggle('Auto Shark Saw', _G.Settings.Items["Auto Shark Saw"], function(state)
        _G.Settings.Items["Auto Shark Saw"] = state;
        StopTween(_G.Settings.Items["Auto Shark Saw"]);
        (getgenv()).SaveSetting();
    end)
AutoPoleToggle = ItemsTab:CreateToggle('Auto Pole', _G.Settings.Items["Auto Pole"], function(state)
        _G.Settings.Items["Auto Pole"] = state;
        StopTween(_G.Settings.Items["Auto Pole"]);
        (getgenv()).SaveSetting();
    end)
AutoDarkDaggerToggle = ItemsTab:CreateToggle('Auto Dark Dagger', _G.Settings.Items["Auto Dark Dagger"], function(state)
        _G.Settings.Items["Auto Dark Dagger"] = state;
        StopTween(_G.Settings.Items["Auto Dark Dagger"]);
        (getgenv()).SaveSetting();
    end)
AutoAddMeleeStats = StatsTab:CreateToggle('Add Melee Stats', _G.Settings.Stats["Auto Add Melee Stats"], function(state)
        _G.Settings.Stats["Auto Add Melee Stats"] = state;
    end)
AutoAddDefenseStats = StatsTab:CreateToggle('Add Defense Stats', _G.Settings.Stats["Auto Add Defense Stats"], function(state)
        _G.Settings.Stats["Auto Add Defense Stats"] = state;
    end)
AutoAddSwordStats = StatsTab:CreateToggle('Add Sword Stats', _G.Settings.Stats["Auto Add Sword Stats"], function(state)
        _G.Settings.Stats["Auto Add Sword Stats"] = state;
    end)
AutoAddGunStats = StatsTab:CreateToggle('Add Gun Stats', _G.Settings.Stats["Auto Add Gun Stats"], function(state)
        _G.Settings.Stats["Auto Add Gun Stats"] = state;
    end)
AutoAddDevilFruitStats = StatsTab:CreateToggle('Add Devil Fruit Stats', _G.Settings.Stats["Auto Add Devil Fruit Stats"], function(state)
        _G.Settings.Stats["Auto Add Devil Fruit Stats"] = state;
    end)
AutoRaidToggle = RaidTab:CreateToggle('Auto Raid', _G.Settings.Raid["Auto Raid"], function(state)
        _G.Settings.Raid["Auto Raid"] = state;
        StopTween(_G.Settings.Raid["Auto Raid"]);
        (getgenv()).SaveSetting();
    end)
AutoAwakeningToggle = RaidTab:CreateToggle('Auto Awaken', _G.Settings.Raid["Auto Awaken"], function(state)
        _G.Settings.Raid["Auto Awaken"] = state;
        (getgenv()).SaveSetting();
    end)
AutoUnstoreDevilFruitToggle = RaidTab:CreateToggle('Auto Unstore Devil Fruit', _G.Settings.Raid["Unstore Devil Fruit"], function(state)
        _G.Settings.Raid["Unstore Devil Fruit"] = state;
        (getgenv()).SaveSetting();
    end)
AutoLawRaidToggle = RaidTab:CreateToggle('Auto Law Raid', _G.Settings.Raid["Law Raid"], function(state)
        _G.Settings.Raid["Law Raid"] = value;
        StopTween(_G.Settings.Raid["Law Raid"]);
        (getgenv()).SaveSetting();
    end)
TeleportToPlaceToggle = RaceTab:CreateToggle('Teleport To Place', _G.Settings.Race["Teleport To Place"], function(state)
        _G.Settings.Race["Teleport To Place"] = state;
        (getgenv()).SaveSetting();
    end)
AutoBuyGearToggle = RaceTab:CreateToggle('Auto Buy Gear', _G.Settings.Race["Auto Buy Gear"], function(state)
        _G.Settings.Race["Auto Buy Gear"] = state;
        (getgenv()).SaveSetting();
    end)
TweenToMirageIslandToggle = RaceTab:CreateToggle('Tween To Mirage Island', _G.Settings.Race["Tween To Highest Mirage"], function(state)
        _G.Settings.Race["Tween To Highest Mirage"] = state;
        (getgenv()).SaveSetting();
    end)
FindBlueGearToggle = RaceTab:CreateToggle('Find Blue Gear', _G.Settings.Race["Find Blue Gear"], function(state)
        _G.Settings.Race["Find Blue Gear"] = state;
        (getgenv()).SaveSetting();
    end)
LookMoonAbilityToggle = RaceTab:CreateToggle('Look Moon & use Ability', _G.Settings.Race["Look Moon Ability"], function(state)
        _G.Settings.Race["Look Moon Ability"] = state;
        (getgenv()).SaveSetting();
    end)
AutoTrainToggle = RaceTab:CreateToggle('Auto Train', _G.Settings.Race["Auto Train"], function(state)
        _G.Settings.Race["Auto Train"] = state;
        StopTween(_G.Settings.Race["Auto Train"]);
        (getgenv()).SaveSetting();
    end)
AutoTrialToggle = RaceTab:CreateToggle('Auto Trial', _G.Settings.Race["Auto Trial"], function(value)
        _G.Settings.Race["Auto Trial"] = value;
        StopTween(_G.Settings.Race["Auto Trial"]);
        (getgenv()).SaveSetting();
    end)
AutoKillPlayerAfterTrialToggle = RaceTab:CreateToggle('Auto Kill Player After Trial', _G.Settings.Race["Auto Kill Player After Trial"], function(value)
        _G.Settings.Race["Auto Kill Player After Trial"] = value;
        (getgenv()).SaveSetting();
    end)
AutoBuyLegendarySwordToggle = ShopTab:CreateToggle('Auto Buy Legendary Sword', _G.Settings.Shop["Auto Buy Legendary Sword"], function(state)
        _G.Settings.Shop["Auto Buy Legendary Sword"] = state;
        (getgenv()).SaveSetting();
    end)
AutoBuyHakiColorToggle = ShopTab:CreateToggle('Auto Buy Haki Color', _G.Settings.Shop["Auto Buy Haki Color"], function(state)
        _G.Settings.Shop["Auto Buy Haki Color"] = state;
        (getgenv()).SaveSetting();
    end)
SpectatePlayerToggle = CombatTab:CreateToggle('Spectate Player', false, function(state)
        SpectatePlys = state;
        repeat
            wait(0.1);
            (game:GetService("Workspace")).Camera.CameraSubject =
...
TeleportToPlayerToggle = CombatTab:CreateToggle('Teleport To Player', false, function(state)
        _G.TeleportToPlayer = value;
        pcall(function()
            if _G.TeleportToPlayer then
                repeat
...
AutoTeleportToIslandToggle = TeleportTab:CreateToggle('Teleport To Island', false, function(state)
        _G.TeleportIsland = state;
        if _G.TeleportIsland then
            repeat
                wait();
...
TeleportToNpcToggle = TeleportTab:CreateToggle('Teleport To Npc', false, function(state)
        _G.TeleportNPC = state;
        if _G.TeleportNPC then
            repeat
                wait();
...
EspPlayerToggle = EspTab:CreateToggle('Esp Player', _G.Settings.Esp["ESP Player"], function(state)
        _G.Settings.Esp["ESP Player"] = state;
    end)
EspChestToggle = EspTab:CreateToggle('Esp Chest', _G.Settings.Esp["ESP Chest"], function(state)
        _G.Settings.Esp["ESP Chest"] = state;
    end)
EspDevilFruitToggle = EspTab:CreateToggle('Esp DevilFruit', _G.Settings.Esp["ESP DevilFruit"], function(state)
        _G.Settings.Esp["ESP DevilFruit"] = state;
    end)
EspRealFruitToggle = EspTab:CreateToggle('Esp RealFruit', _G.Settings.Esp["ESP RealFruit"], function(state)
        _G.Settings.Esp["ESP RealFruit"] = state;
    end)
EspFlowerToggle = EspTab:CreateToggle('Esp Flower', _G.Settings.Esp["ESP Flower"], function(state)
        _G.Settings.Esp["ESP Flower"] = state;
    end)
EspIslandToggle = EspTab:CreateToggle('Esp Island', _G.Settings.Esp["ESP Island"], function(state)
        _G.Settings.Esp["ESP Island"] = state;
    end)
EspNpcToggle = EspTab:CreateToggle('Esp Npc', _G.Settings.Esp["ESP Npc"], function(state)
        _G.Settings.Esp["ESP Npc"] = state;
    end)
EspSeaBeastToggle = EspTab:CreateToggle('Esp Sea Beast', _G.Settings.Esp["ESP Sea Beast"], function(state)
        _G.Settings.Esp["ESP Sea Beast"] = state;
    end)
EspMonsterToggle = EspTab:CreateToggle('Esp Monster', _G.Settings.Esp["ESP Monster"], function(state)
        _G.Settings.Esp["ESP Monster"] = state;
    end)
EspMirageIslandToggle = EspTab:CreateToggle('Esp Mirage Island', _G.Settings.Esp["ESP Mirage"], function(state)
        _G.Settings.Esp["ESP Mirage"] = state;
    end)
EspKitsuneIslandToggle = EspTab:CreateToggle('Esp Kitsune Island', _G.Settings.Esp["ESP Kitsune"], function(state)
        _G.Settings.Esp["ESP Kitsune"] = state;
    end)
EspFrozenDimensionToggle = EspTab:CreateToggle('Esp Frozen Dimension', _G.Settings.Esp["ESP Frozen"], function(state)
        _G.Settings.Esp["ESP Frozen"] = state;
    end)
EspPrehistoricIslandToggle = EspTab:CreateToggle('Esp Prehistoric Island', _G.Settings.Esp["ESP Prehistoric"], function(state)
        _G.Settings.Esp["ESP Prehistoric"] = state;
    end)
EspGearToggle = EspTab:CreateToggle('Esp Gear', _G.Settings.Esp["ESP Gear"], function(state)
        _G.Settings.Esp["ESP Gear"] = state;
    end)
AutoFarmBlazeEmberToggle = DragonDojoTab:CreateToggle('Auto Farm Blaze Ember', _G.Settings.DragonDojo["Auto Farm Blaze Ember"], function(state)
        _G.Settings.DragonDojo["Auto Farm Blaze Ember"] = state;
        StopTween(_G.Settings.DragonDojo["Auto Farm Blaze Ember"]);
        (getgenv()).SaveSetting();
    end)
AutoSailBoatToggle = SeaEventTab:CreateToggle('Sail Boat', _G.Settings.SeaEvent["Sail Boat"], function(state)
        _G.Settings.SeaEvent["Sail Boat"] = state;
        StopTween(_G.Settings.SeaEvent["Sail Boat"]);
        (getgenv()).SaveSetting();
        if not _G.Settings.SeaEvent["Sail Boat"] then
...
AutoFarmSharkToggle = SeaEventTab:CreateToggle('Auto Farm Shark', _G.Settings.SeaEvent["Auto Farm Shark"], function(state)
        _G.Settings.SeaEvent["Auto Farm Shark"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Shark"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmPiranhaToggle = SeaEventTab:CreateToggle('Auto Farm Piranha', _G.Settings.SeaEvent["Auto Farm Piranha"], function(state)
        _G.Settings.SeaEvent["Auto Farm Piranha"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Piranha"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmFishCrewMemberToggle = SeaEventTab:CreateToggle('Auto Farm Fish Crew Member', _G.Settings.SeaEvent["Auto Farm Fish Crew Member"], function(state)
        _G.Settings.SeaEvent["Auto Farm Fish Crew Member"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Fish Crew Member"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmGhostShipToggle = SeaEventTab:CreateToggle('Auto Farm Ghost Ship', _G.Settings.SeaEvent["Auto Farm Ghost Ship"], function(state)
        _G.Settings.SeaEvent["Auto Farm Ghost Ship"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Ghost Ship"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmPirateBrigadeToggle = SeaEventTab:CreateToggle('Auto Farm Pirate Brigade', _G.Settings.SeaEvent["Auto Farm Pirate Brigade"], function(state)
        _G.Settings.SeaEvent["Auto Farm Pirate Brigade"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Pirate Brigade"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmPirateGrandBrigadeToggle = SeaEventTab:CreateToggle('Auto Farm Pirate Grand Brigade', _G.Settings.SeaEvent["Auto Farm Pirate Grand Brigade"], function(state)
        _G.Settings.SeaEvent["Auto Farm Pirate Grand Brigade"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Pirate Grand Brigade"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmTerrorsharkToggle = SeaEventTab:CreateToggle('Auto Farm Terrorshark', _G.Settings.SeaEvent["Auto Farm Terrorshark"], function(state)
        _G.Settings.SeaEvent["Auto Farm Terrorshark"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Terrorshark"]);
        (getgenv()).SaveSetting();
    end)
AutoFarmSeabeastsToggle = SeaEventTab:CreateToggle('Auto Farm Seabeasts', _G.Settings.SeaEvent["Auto Farm Seabeasts"], function(state)
        _G.Settings.SeaEvent["Auto Farm Seabeasts"] = state;
        StopTween(_G.Settings.SeaEvent["Auto Farm Seabeasts"]);
        (getgenv()).SaveSetting();
    end)
AutoSummonPrehistoricIslandToggle = SeaStackTab:CreateToggle('Summon Prehistoric Island', _G.Settings.SeaStack["Summon Prehistoric Island"], function(state)
        _G.Settings.SeaStack["Summon Prehistoric Island"] = state;
        StopTween(_G.Settings.SeaStack["Summon Prehistoric Island"]);
        (getgenv()).SaveSetting();
    end)
TweenToPrehistoricIslandToggle = SeaStackTab:CreateToggle('Tween To Prehistoric Island', _G.Settings.SeaStack["Tween To Prehistoric Island"], function(state)
        _G.Settings.SeaStack["Tween To Prehistoric Island"] = state;
        StopTween(_G.Settings.SeaStack["Tween To Prehistoric Island"]);
        (getgenv()).SaveSetting();
    end)
AutoKillLavaGolemToggle = SeaStackTab:CreateToggle('Auto Kill Lava Golem', _G.Settings.SeaStack["Auto Kill Lava Golem"], function(state)
        _G.Settings.SeaStack["Auto Kill Lava Golem"] = state;
        StopTween(_G.Settings.SeaStack["Auto Kill Lava Golem"]);
        (getgenv()).SaveSetting();
    end)
AutoSummonFrozenDimensionToggle = SeaStackTab:CreateToggle('Summon Frozen Dimension', _G.Settings.SeaStack["Summon Frozen Dimension"], function(state)
        _G.Settings.SeaStack["Summon Frozen Dimension"] = state;
        StopTween(_G.Settings.SeaStack["Summon Frozen Dimension"]);
        (getgenv()).SaveSetting();
    end)
TweenToFrozenDimensionToggle = SeaStackTab:CreateToggle('Tween To Frozen Dimension', _G.Settings.SeaStack["Tween To Frozen Dimension"], function(state)
        _G.Settings.SeaStack["Tween To Frozen Dimension"] = state;
        StopTween(_G.Settings.SeaStack["Tween To Frozen Dimension"]);
        (getgenv()).SaveSetting();
    end)
AutoSummonKitsuneIslandToggle = SeaStackTab:CreateToggle('Summon Kitsune Island', _G.Settings.SeaStack["Summon Kitsune Island"], function(state)
        _G.Settings.SeaStack["Summon Kitsune Island"] = state;
        StopTween(_G.Settings.SeaStack["Summon Kitsune Island"]);
        (getgenv()).SaveSetting();
    end)
TweenToKitsuneIslandToggle = SeaStackTab:CreateToggle('Tween To Kitsune Island', _G.Settings.SeaStack["Tween To Kitsune Island"], function(state)
        _G.Settings.SeaStack["Tween To Kitsune Island"] = state;
        StopTween(_G.Settings.SeaStack["Tween To Kitsune Island"]);
        (getgenv()).SaveSetting();
    end)
AutoCollectAzureEmberToggle = SeaStackTab:CreateToggle('Auto Collect Azure Ember', _G.Settings.SeaStack["Auto Collect Azure Ember"], function(state)
        _G.Settings.SeaStack["Auto Collect Azure Ember"] = state;
        (getgenv()).SaveSetting();
    end)
AutoTradeAzureEmberToggle = SeaStackTab:CreateToggle('Auto Trade Azure Ember', _G.Settings.SeaStack["Auto Trade Azure Ember"], function(state)
        _G.Settings.SeaStack["Auto Trade Azure Ember"] = state;
        (getgenv()).SaveSetting();
    end)
TweenToMirageIslandToggle = SeaStackTab:CreateToggle('Tween To Mirage Island', _G.Settings.SeaStack["Tween To Mirage Island"], function(state)
        _G.Settings.SeaStack["Tween To Mirage Island"] = state;
        StopTween(_G.Settings.SeaStack["Tween To Mirage Island"]);
        (getgenv()).SaveSetting();
    end)
AutoAttackSeaBeastsToggle = SeaStackTab:CreateToggle('Auto Attack Seabeasts', _G.Settings.SeaStack["Auto Attack Seabeasts"], function(state)
        _G.Settings.SeaStack["Auto Attack Seabeasts"] = state;
        StopTween(_G.Settings.SeaStack["Auto Attack Seabeasts"]);
        (getgenv()).SaveSetting();
    end)
LightningToggle = SeaSettingsTab:CreateToggle('Lightning', _G.Settings.SettingSea.Lightning, function(state)
        _G.Settings.SettingSea.Lightning = state;
    end)
IncreaseSpeedBoatToggle = SeaSettingsTab:CreateToggle('Increase Speed Boat', _G.Settings.SettingSea["Increase Speed Boat"], function(state)
        _G.Settings.SettingSea["Increase Speed Boat"] = state;
    end)
NoClipRockToggle = SeaSettingsTab:CreateToggle('No Clip Rock', _G.Settings.SettingSea["No Clip Rock"], function(state)
        _G.Settings.SettingSea["No Clip Rock"] = state;
    end)
UseDevilFruitSkillToggle = SeaSettingsTab:CreateToggle('Use Devil Fruit Skill', true, function(state)
        _G.Settings.SettingSea["Use Devil Fruit Skill"] = state;
        (getgenv()).SaveSetting();
    end)
UseMeleeSkillToggle = SeaSettingsTab:CreateToggle('Use Melee Skill', true, function(state)
        _G.Settings.SettingSea["Use Melee Skill"] = state;
        (getgenv()).SaveSetting();
    end)
UseSwordSkillToggle = SeaSettingsTab:CreateToggle('Use Sword Skill', true, function(state)
        _G.Settings.SettingSea["Use Sword Skill"] = state;
        (getgenv()).SaveSetting();
    end)
UseGunSkillToggle = SeaSettingsTab:CreateToggle('Use Gun Skill', true, function(state)
        _G.Settings.SettingSea["Use Gun Skill"] = state;
        (getgenv()).SaveSetting();
    end)
DevilFruitZSkillToggle = SeaSettingsTab:CreateToggle('Devil Fruit Z Skill', true, function(state)
        _G.Settings.SettingSea["Devil Fruit Z Skill"] = state;
        (getgenv()).SaveSetting();
    end)
DevilFruitXSkillToggle = SeaSettingsTab:CreateToggle('Devil Fruit X Skill', true, function(state)
        _G.Settings.SettingSea["Devil Fruit X Skill"] = state;
        (getgenv()).SaveSetting();
    end)
DevilFruitCSkillToggle = SeaSettingsTab:CreateToggle('Devil Fruit C Skill', true, function(state)
        _G.Settings.SettingSea["Devil Fruit C Skill"] = state;
        (getgenv()).SaveSetting();
    end)
DevilFruitVSkillToggle = SeaSettingsTab:CreateToggle('Devil Fruit V Skill', _G.Settings.SettingSea["Devil Fruit V Skill"], function(state)
        _G.Settings.SettingSea["Devil Fruit V Skill"] = state;
        (getgenv()).SaveSetting();
    end)
DevilFruitFSkillToggle = SeaSettingsTab:CreateToggle('Devil Fruit F Skill', _G.Settings.SettingSea["Devil Fruit F Skill"], function(state)
        _G.Settings.SettingSea["Devil Fruit F Skill"] = state;
        (getgenv()).SaveSetting();
    end)
MeleeZSkillToggle = SeaSettingsTab:CreateToggle('Melee Z Skill', true, function(state)
        _G.Settings.SettingSea["Melee Z Skill"] = state;
        (getgenv()).SaveSetting();
    end)
MeleeXSkillToggle = SeaSettingsTab:CreateToggle('Melee X Skill', true, function(state)
        _G.Settings.SettingSea["Melee X Skill"] = state;
        (getgenv()).SaveSetting();
    end)
MeleeCSkillToggle = SeaSettingsTab:CreateToggle('Melee C Skill', true, function(state)
        _G.Settings.SettingSea["Melee C Skill"] = state;
        (getgenv()).SaveSetting();
    end)
MeleeVSkillToggle = SeaSettingsTab:CreateToggle('Melee V Skill', true, function(state)
        _G.Settings.SettingSea["Melee V Skill"] = state;
        (getgenv()).SaveSetting();
    end)
AutoActiveRaceV3Toggle = LocalPlayerTab:CreateToggle('Active Race V3', _G.Settings.LocalPlayer["Active Race V3"], function(state)
        _G.Settings.LocalPlayer["Active Race V3"] = state;
        (getgenv()).SaveSetting();
    end)
AutoActiveRaceV4Toggle = LocalPlayerTab:CreateToggle('Active Race V4', _G.Settings.LocalPlayer["Active Race V4"], function(state)
        _G.Settings.LocalPlayer["Active Race V4"] = state;
        (getgenv()).SaveSetting();
    end)
WalkOnWaterToggle = LocalPlayerTab:CreateToggle('Walk On Water', _G.Settings.LocalPlayer["Walk On Water"], function(state)
        _G.Settings.LocalPlayer["Walk On Water"] = state;
        (getgenv()).SaveSetting();
    end)
NoClipPlayerToggle = LocalPlayerTab:CreateToggle('No Clip', _G.Settings.LocalPlayer["No Clip"], function(state)
        _G.Settings.LocalPlayer["No Clip"] = state;
        (getgenv()).SaveSetting();
    end)
AutoRandomFruitToggle = FruitTab:CreateToggle('Auto Random Fruit', _G.Settings.Fruit["Auto Buy Random Fruit"], function(state)
        _G.Settings.Fruit["Auto Buy Random Fruit"] = state;
    end)
AutoStoreFruitToggle = FruitTab:CreateToggle('Auto Store Fruit', _G.Settings.Fruit["Auto Store Fruit"], function(state)
        _G.Settings.Fruit["Auto Store Fruit"] = state;
        (getgenv()).SaveSetting();
    end)
FruitNotification = FruitTab:CreateToggle('Fruit Notification', _G.Settings.Fruit["Fruit Notification"], function(state)
        _G.Settings.Fruit["Fruit Notification"] = value;
        (getgenv()).SaveSetting();
    end)
TeleportToFruitToggle = FruitTab:CreateToggle('Teleport To Fruit', _G.Settings.Fruit["Teleport To Fruit"], function(state)
        _G.Settings.Fruit["Teleport To Fruit"] = state;
        (getgenv()).SaveSetting();
    end)
TweenToFruitToggle = FruitTab:CreateToggle('Tween To Fruit', _G.Settings.Fruit["Tween To Fruit"], function(state)
        _G.Settings.Fruit["Tween To Fruit"] = state;
        (getgenv()).SaveSetting();
    end)
TeleportTolabButton = RaidTab:CreateButton('Teleport To Lab', function()
        if World2 then
            TweenPlayer(CFrame.new(-6438.73535, 250.645355, -4501.50684));
        elseif World3 then
            TweenPlayer(CFrame.new(-5017.40869, 314.844055, -2823.0127, -0.925743818, 0.0000000448217499, -0.378151238,
...
TeleportToRaceDoorButton = RaceTab:CreateButton('Teleport To Race Door', function()
        (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875,
            14895.3017578125, 102.62469482421875);
        wait(0.1);
        (game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875,
...
BuyAcientQuestButton = RaceTab:CreateButton('Buy Acient Quest', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("UpgradeRace", "Buy");
    end)
TeleportToFirstSeaButton = TeleportTab:CreateButton('Teleport To First Sea', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelMain");
    end)
TeleportToSecondSeaButton = TeleportTab:CreateButton('Teleport To Second Sea', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelDressrosa");
    end)
TeleportToThirdSeaButton = TeleportTab:CreateButton('Teleport To Third Sea', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelZou");
    end)
BuyGeppoButton = ShopTab:CreateButton('Buy Geppo', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Geppo");
    end)
BuyBusoHaki = ShopTab:CreateButton('Buy Buso Haki', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Buso");
    end)
BuySoruButton = ShopTab:CreateButton('Buy Soru', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Soru");
    end)
BuyObservationHakiButton = ShopTab:CreateButton('Buy Observation Haki', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("KenTalk", "Buy");
    end)
BuyBlackLegButton = ShopTab:CreateButton('Buy Black Leg', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyBlackLeg");
    end)
BuyElectroButton = ShopTab:CreateButton('Buy Electro', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyElectro");
    end)
BuyFishmanKarateButton = ShopTab:CreateButton('Buy Fishman Karate', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyFishmanKarate");
    end)
BuyDragonClawButton = ShopTab:CreateButton('Buy Dragon Claw', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "DragonClaw", "1");
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "DragonClaw", "2");
    end)
BuySuperhumanButton = ShopTab:CreateButton('Buy Superhuman', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySuperhuman");
    end)
BuyDeathStepButton = ShopTab:CreateButton('Buy Death Step', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyDeathStep");
    end)
BuySharkmanKarateButton = ShopTab:CreateButton('Buy Sharkman Karate', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySharkmanKarate", true);
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySharkmanKarate");
    end)
BuyElectricClawButton = ShopTab:CreateButton('Buy Electric Claw', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyElectricClaw");
    end)
BuyDragonTalonButton = ShopTab:CreateButton('Buy Dragon Talon', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyDragonTalon");
    end)
BuyGodHumanButton = ShopTab:CreateButton('Buy God Human', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyGodhuman");
    end)
BuySanguineArtButton = ShopTab:CreateButton('Buy Sanguine Art', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySanguineArt", true);
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySanguineArt");
    end)
BuyCutlassButton = ShopTab:CreateButton('Buy Cutlass', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Cutlass");
    end)
BuyKatanaButton = ShopTab:CreateButton('Buy Katana', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Katana");
    end)
BuyIronMaceButton = ShopTab:CreateButton('Buy Iron Mace', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Iron Mace");
    end)
BuyDualKatanaButton = ShopTab:CreateButton('Buy Dual Katana', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Dual Katana");
    end)
BuyTripleKatanaButton = ShopTab:CreateButton('Buy Triple Katana', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Triple Katana");
    end)
BuyPipeButton = ShopTab:CreateButton('Buy Pipe', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Pipe");
    end)
BuyDualHeadedBladeButton = ShopTab:CreateButton('Buy Dual Headed Blade', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Dual-Headed Blade");
    end)
BuyBisentoButton = ShopTab:CreateButton('Buy Bisento', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Bisento");
    end)
BuySoulCaneButton = ShopTab:CreateButton('Buy Soul Cane', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Soul Cane");
    end)
BuySlingshotButton = ShopTab:CreateButton('Buy Slingshot', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Slingshot");
    end)
BuyMusketButton = ShopTab:CreateButton('Buy Musket', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Musket");
    end)
BuyFintlockButton = ShopTab:CreateButton('Buy Flintlock', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Flintlock");
    end)
BuyRefinedFintlockButton = ShopTab:CreateButton('Buy Refined Fintlock', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Refined Fintlock");
    end)
BuyCanonButton = ShopTab:CreateButton('Buy Cannon', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Cannon");
    end)
BuyKabuchaButton = ShopTab:CreateButton('Buy Kabucha', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Slingshot", "1");
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Slingshot", "2");
    end)
ResetStatsShopButton = ShopTab:CreateButton('Reset Stats', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "1");
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "2");
    end)
RandomRaceShopButton = ShopTab:CreateButton('Random Race', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "1");
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "2");
    end)
BuyBlackCapeButton = ShopTab:CreateButton('Buy Black Cape', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Black Cape");
    end)
BuySwordsmanHatButton = ShopTab:CreateButton('Buy Swordsman Hat', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Swordsman Hat");
    end)
BuyTomoeRingButton = ShopTab:CreateButton('Buy Tomoe Ring', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Tomoe Ring");
    end)
RefreshPlayerButton = CombatTab:CreateButton('Refresh Player', function()
        PlayerList = {};
        for i, v in pairs((game:GetService("Players")):GetChildren()) do
            table.insert(PlayerList, v.Name);
        end
...
CraftVolcanicMagnetButton = DragonDojoTab:CreateButton('Craft Volcanic Magnet', function()
        (((game:GetService("ReplicatedStorage")):WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer(
            "CraftItem", "Craft", "Volcanic Magnet");
    end)
BribeLeviathanButton = SeaStackTab:CreateButton('Bribe Leviathan', function()
        local Status = (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("InfoLeviathan", "2");
        BribeLeviathanStatusParagraph:SetDesc(Status);
    end)
GrabFruitButton = FruitTab:CreateButton('Grab Fruit', function()
        for i, v in pairs(game.Workspace:GetChildren()) do
            if v:IsA("Tool") then
                v.Handle.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
            end
...
RainFruitButton = FruitTab:CreateButton('Rain Fruit', function()
        rainFruit();
    end)
JoinPiratesTeamButton = MiscTab:CreateButton('Join Pirates Team', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Pirates");
    end)
JoinMarinesTeamButton = MiscTab:CreateButton('Join Marines Team', function()
        (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Marines");
    end)
RedeemAllCodesButton = MiscTab:CreateButton('Redeem All Codes', function()
        for i, v in pairs(codeList) do
            redeemCode(v);
        end
    end)
FpsBoostButton = MiscTab:CreateButton('Fps Boost (Roblox)', function()
        boostFps();
    end)
FpsBoostButton = MiscTab:CreateButton('Fps Boost (Vylera Hub)', function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/dyumra/DYHUB-Universal-Game/refs/heads/main/Nigga.lua"))()
    end)
RemoveFogButton = MiscTab:CreateButton('Remove Fog', function()
        (game:GetService("Lighting")).LightingLayers:Destroy();
        (game:GetService("Lighting")).Sky:Destroy();
        game.Lighting.FogEnd = 9000000000;
    end)
RemoveLavaButton = MiscTab:CreateButton('Remove Lava', function()
        for i, v in pairs(game.Workspace:GetDescendants()) do
            if v.Name == "Lava" then
                v:Destroy();
            end
...
RejoinServerButton = ServerTab:CreateButton('Rejoin Server', function()
        (game:GetService("TeleportService")):Teleport(game.PlaceId);
    end)
ServerHopButton = ServerTab:CreateButton('Server Hop', function()
        local module = (loadstring(game:HttpGet(
            "https://raw.githubusercontent.com/raw-scriptpastebin/FE/main/Server_Hop_Settings")))();
        module:Teleport(game.PlaceId);
    end)
JoinJobIdButton = ServerTab:CreateButton('Join Job ID', function()
        (game:GetService("TeleportService")):TeleportToPlaceInstance(game.PlaceId, _G.JobId);
    end)
ChooseWeaponDropdown = MainTab:CreateDropdown('Choose Weapon', WeaponList, _G.Settings.Main["Select Weapon"], function(option)
        _G.Settings.Main["Select Weapon"] = option;
        (getgenv()).SaveSetting();
    end)
LevelFarmMethodDropdown = MainTab:CreateDropdown('Choose Farm Level Method', LevelFarmMethodList, _G.Settings.Main["Farm Level Method"], function(option)
        _G.Settings.Main["Farm Level Method"] = option;
        (getgenv()).SaveSetting();
    end)
MasteryMethodDropdown = MainTab:CreateDropdown('Choose Mastery Method', MasteryMethodList, _G.Settings.Main["Mastery Method"], function(option)
        _G.Settings.Main["Mastery Method"] = option;
        (getgenv()).SaveSetting();
    end)
ChooseSwordDropdown = MainTab:CreateDropdown('Choose Sword', SwordList, _G.Settings.Main["Selected Mastery Sword"], function(option)
        _G.Settings.Main["Selected Mastery Sword"] = option;
        (getgenv()).SaveSetting();
    end)
ChooseMonDropdown = MainTab:CreateDropdown('Choose Mon', tableMon, _G.Settings.Main["Selected Mon"], function(option)
        _G.Settings.Main["Selected Mon"] = option;
        (getgenv()).SaveSetting();
    end)
ChooseBossDropdown = MainTab:CreateDropdown('Choose Boss', tableBoss, _G.Settings.Main["Selected Boss"], function(option)
        _G.Settings.Main["Selected Boss"] = option;
        (getgenv()).SaveSetting();
    end)
BoneFarmMethodDropdown = OthersTab:CreateDropdown('Choose Bone Farm Method', listBoneFarmMethod, _G.Settings.Farm["Selected Bone Farm Method"], function(option)
        _G.Settings.Farm["Selected Bone Farm Method"] = option;
        (getgenv()).SaveSetting();
    end)
MaterialDropdown = OthersTab:CreateDropdown('Choose Material', MaterialList, _G.Settings.Farm["Selected Material"], function(option)
        _G.Settings.Farm["Selected Material"] = option;
    end)
BringMobDropdown = SettingsTab:CreateDropdown('Bring Mob', BringList, _G.Settings.Setting["Fast Attack Mode"], function(option)
        _G.Settings.Setting["Fast Attack Mode"] = option;
    end)
ChooseChipRaidDropdown = RaidTab:CreateDropdown('Choose Chip', Raidslist, _G.Settings.Raid["Selected Chip"], function(option)
        _G.Settings.Raid["Selected Chip"] = option;
    end)
SelectedPlaceDropdown = RaceTab:CreateDropdown('Selected Place', PlaceV4List, _G.Settings.Race["Selected Place"], function(value)
        _G.Settings.Race["Selected Place"] = value;
        (getgenv()).SaveSetting();
    end)
SelectedPlayerDropdown = CombatTab:CreateDropdown('Choose Player', PlayerList, tostring(PlayerList[1]), function(option)
        _G.SelectedPlayer = option;
    end)
SelectedTeleportIslandDropdown = TeleportTab:CreateDropdown('Choose Island', IslandList, IslandList[1], function(option)
        _G.SelectIsland = option;
    end)
SelectedNpcTeleport = TeleportTab:CreateDropdown('Choose Npc', NpcList, NpcList[1], function(option)
        _G.SelectNPC = option;
    end)
ChooseBoatDropdown = SeaEventTab:CreateDropdown('Choose Boat', BoatList, _G.Settings.SeaEvent["Selected Boat"], function(option)
        _G.Settings.SeaEvent["Selected Boat"] = option;
        (getgenv()).SaveSetting();
    end)
ChooseZoneDropdown = SeaEventTab:CreateDropdown('Choose Zone', ZoneList, _G.Settings.SeaEvent["Selected Zone"], function(option)
        _G.Settings.SeaEvent["Selected Zone"] = option;
        (getgenv()).SaveSetting();
    end)
StoreRarityFruitDropdown = FruitTab:CreateDropdown('Store Rarity Fruit', SelectRarityFruits, _G.Settings.Fruit["Store Rarity Fruit"], function(option)
        _G.Settings.Fruit["Store Rarity Fruit"] = option;
        (getgenv()).SaveSetting();
    end)