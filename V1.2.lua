    ...
    function Window:CreateTab(name)
        ...
        function Tab:Paragraph(data)
            ...
            function obj:SetDesc(desc)
                -- We can't easily update the text of the button in this simple UI without a reference
                -- But we can at least prevent the error
            end
...
Tabs.MainTab:CreateDropdown("Select Weapon", {"Melee", "Sword", "Blox Fruit", "Gun"}, function(v) _G.Settings.Main["Select Weapon"] = v end)
Tabs.MainTab:CreateDropdown("Farm Method", {"Quest", "Chest", "Monster"}, function(v) _G.Settings.Main["Farm Level Method"] = v end)
Tabs.MainTab:CreateToggle("Auto Farm Level", function(v) _G.Settings.Main["Auto Farm"] = v end)
Tabs.MainTab:CreateToggle("Auto Fast Farm", function(v) _G.Settings.Main["Auto Fast Farm"] = v end)

Tabs.SettingsTab:CreateDropdown("Fast Attack Mode", {"Normal", "Fast", "Slow"}, function(v) _G.Settings.Setting["Fast Attack Mode"] = v end)
Tabs.SettingsTab:CreateToggle("Fast Attack", function(v) _G.Settings.Setting["Fast Attack"] = v end)
